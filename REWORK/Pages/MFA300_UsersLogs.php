<?php 
  ...
  $sql = "SELECT count(*) AS total FROM logs.mfa300 WHERE Status=1";
    ...
    <body>
      <div class="container">
                  ...
                  <table class="table table-striped table-dark">
                    <thead>
                      <tr>
                        <th scope="col" colspan="5" class="text-center text-warning"><h3 class="float-left text-success">Prijavljeni: <?php echo $res['total']; ?>/23</h3><h3>MFA300 - Lista prijavljenih korisnika</h3></th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      $i = 1;
                             foreach($xml->mfa[0]->mfa300 as $m){
                               $sql1 = "SELECT * FROM logs.mfa300 WHERE Status=1 AND Post='$m->celija'";
